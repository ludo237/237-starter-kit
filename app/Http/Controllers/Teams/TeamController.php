...
class TeamController extends Controller
{
    ...
    public function edit(Request $request, Team $team): Response
    {
        ...
        return Inertia::render('teams/edit', [
            'team' => [
                'id' => $team->getKey(),
                'name' => $team->getAttributeValue('name'),
                'slug' => $team->getAttributeValue('slug'),
                'isPersonal' => $team->getAttributeValue('is_personal'),
            ],
            'members' => $team->members()->get()->map(fn ($member): array => [
                'id' => $member->getKey(),
                'name' => $member->getAttributeValue('name'),
                'email' => $member->getAttributeValue('name'),
                'avatar' => $member->getAttributeValue('avatar') ?? null,
            ...
            'invitations' => $team->invitations()
                ...
                ->map(fn ($invitation): array => [
                    'code' => $invitation->getAttributeValue('code'),
                    'email' => $invitation->getAttributeValue('email'),
                    'role' => $invitation->role->value,
                    'role_label' => $invitation->role->label(),
                    'created_at' => $invitation->getAttributeValue('created_at')->toISOString(),
                ]),
